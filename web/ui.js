...
const ICONS = {
  ...
  /* 護符。**お守りの形にする**（2026-07-29）。直す前は縦長の角丸に横線が2本で、
     護符ではなく電池か戸に見えていた（装備画面の空きスロットに 30px で出る所）。
     紐の輪・口の結び・袋の3つに分ける。`EVENODD` なので**重ねないこと**——
     重ねた分がそのまま穴になる。輪の脚は結びの上端でちょうど終わらせてある。 */
  charm: 'M12 1.4a4.4 4.4 0 0 1 4.4 4.4v1.8h-2.3V5.8a2.1 2.1 0 0 0-4.2 0v1.8H7.6V5.8A4.4 4.4 0 0 1 12 1.4zM6.6 7.6h10.8a0.9 0.9 0 0 1 0 1.8H6.6a0.9 0.9 0 0 1 0-1.8zM7.4 10.6h9.2v7.7a3.3 3.3 0 0 1-3.3 3.3h-2.6a3.3 3.3 0 0 1-3.3-3.3z',
