...
const Master = {
  ...
  doorLines: (chapter) => ({
    1: [
      '誰も歩かなくなった通りに、足音が一つ戻ってくる。',
      'その音を聞きつけて、二階の窓が細く開いた。',
      '「……ウォークかい。まだ歩いてるのか、あんたは」',
    ],
    2: [
      '下りたシャッターの向こうに、まだ誰かがいる気がする。',
      '通りの端から端まで、明かりは一つも点いていない。',
      'ここで止まっているのは、一人ではない。',
    ],
    3: [
      'ここでは、歩くという発想そのものが失われている。',
      '足跡が一つも無い。風が吹いても、灰は動かない。',
      'それでも、底に何かがいる。',
    ],
  }[chapter]),
...
const STORY_SCENES = {
  'boss-1-before': [
    '一番奥の家の前に、それは畳まれて置かれていた。',
    '布団のような形をしている。折り目の間に、人の輪郭が沈んでいる。',
    'この家の主人だ。三日前から、生地をこねる手を止めたまま。',
    '起こすには、先にこれを剥がすしかない。',
  ],
  'boss-1-after': [
    '折り目がほどけて、中から男が転がり出た。',
    'しばらく天井を見て、それから自分の手を見た。',
    '「……こねかけの生地が、あった気がする」',
    '起き上がるのに、誰かの手は要らなかった。ただ、起こす者が要った。',
  ],
  'boss-2-before': [
    'それは通りの真ん中で頭を垂れていた。肩より下に、顔が沈んでいる。',
    '胴にいくつも窪みがある。人の形をした窪みだ。',
    '店主たちの意欲が、一人ずつここへ吸い上げられている。',
    '一軒ずつ起こしていては、間に合わない。',
  ],
  'boss-2-after': [
    '窪みが順に埋まって、それは灰になって崩れた。',
    'シャッターが一枚、また一枚と上がっていく。誰も号令はかけていない。',
    '一人が起きると、その音で隣が起きる。',
  ],
  'boss-3-before': [
    'それは窪地の底で、動かずにいた。',
    '追ってはこない。逃げもしない。ただ、こちらを見ている。',
    '「歩いて、どこへ行く」',
    '答える必要はなかった。ここまで歩いてきたことが、答えだった。',
  ],
  'boss-3-after': [
    '本体が崩れても、灰は残った。',
    '起こした人の数だけ、街に灯りが点いている。まだ点いていない場所の方が、ずっと多い。',
    '終わりではない。ここからは、戻す番だ。',
  ],
};
