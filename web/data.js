...
const VITALITY_SCENES = {
  ...
  '1-45': [
    '潰れたままだった店の戸が、開いていた。',
    '中では老人が、片方だけの靴を手に取って眺めている。',
    '「あんた、よく歩くな。歩き方が靴に出とる」',
  ],
  '1-75': [
    '通りに子どもの声が戻ってきた。',
    '走っているわけではない。ただ、外に出ている。',
  ],
  '1-100': [
    '街灯がすべて点いた。時計はまだ止まっているが、誰かが脚立を立てている。',
    '止まった住宅街は、もう止まっていない。',
  ],
  '2-12': [
    'シャッターが一枚だけ、腰の高さまで上がっている。',
    '中から明かりが漏れている。誰かが在庫を数えている。',
  ],
  '2-45': [
    '通りの真ん中に、台がいくつか並べられていた。',
    '売る物はまだ少ない。それでも値札は手で書かれている。',
    '「余った物があるなら置いていきな。要る物と替えてやる」',
  ],
  '2-75': [
    '半分のシャッターが上がった。',
    '残り半分も開ける理由を探している——という言い方は、もうしなくなった。',
  ],
  '2-100': [
    '端の街灯から順に、誰かが灯りを点けていく。',
    '灯りの落ちた商店街という名前だけが、まだ残っている。',
  ],
  '3-12': [
    '灰の底で、何かが動いた。',
    'ダルモンではない。灰をかき分けて、立ち上がろうとしている。',
  ],
  '3-45': [
    '杭が一本、灰に打ち込まれていた。板が渡してある。',
    '紙が一枚、風で鳴っている。「まだ、うちの前にいる」',
  ],
  '3-75': [
    '灰の上に、道ができていた。',
    '誰かが同じ場所を、何度も歩いた跡だ。',
